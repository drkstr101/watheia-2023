        ...
        <div className="mt-24 sm:mt-32 lg:mt-16">
          <a href="#" className="inline-flex space-x-6">
            ...
            <span className="inline-flex items-center space-x-2 text-sm font-medium leading-6 text-neutral-300">
              ...
              <ChevronRightIcon className="h-5 w-5 text-neutral-500" aria-hidden="true" />
            </span>
          </a>
        </div>
...
export function HomeView(props: HomeViewProps) {
  return (
    <div className="bg-neutral-900" {...props}>
      <main>
        <HeroSection />
        ...
        <div className="relative isolate mt-32 px-6 py-32 sm:mt-56 sm:py-40 lg:px-8">
          ...
          >
            ...
            <svg x="50%" y={0} className="overflow-visible fill-neutral-800/20">
              <path
                d="M-200 0h201v201h-201Z M600 0h201v201h-201Z M-400 600h201v201h-201Z M200 800h201v201h-201Z"
                strokeWidth={0}
              />
